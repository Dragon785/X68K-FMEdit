...
static int oldTextMode=0; // ŽÀs‘O‚ÌƒeƒLƒXƒgŽg—pƒ‚[ƒh
static int oldGraphMode=0; // ŽÀs‘O‚ÌƒOƒ‰ƒtƒBƒbƒNŽg—pƒ‚[ƒh
static int oldFuncKeyMode=0; // ŽÀs‘O‚Ìƒtƒ@ƒ“ƒNƒVƒ‡ƒ“ƒL[ƒ‚[ƒh
static int oldScrollRange=0;
static toneData dispToneData={0}; // •\Ž¦—pƒg[ƒ“ƒf[ƒ^
